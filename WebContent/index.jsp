				...
				<div class="col-md-3">
					<div class="menu_box">
				   	  ...
				   	  for(int i = 0; i < categories.size(); i++) {%>
				   	   <ul class="nav">
    				   		<li id="tt"><input type="radio" id=<%=categories.get(i)%> name="button" value=<%=categories.get(i)%> onclick="document.location.href='<%=categories.get(i).toLowerCase()%>.jsp'"><font face="sans-serif"><b><%=categories.get(i)%></b></font></li>
    				   		<%
				   	    }
				   	     %>
				   	      </ul>
